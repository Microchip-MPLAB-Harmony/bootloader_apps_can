...
{"0": {
    ...
    "url": "http://localhost:4000/bootloader_apps_can/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "CAN Bootloader Host Tools",
    "title": "CAN Bootloader Tools Help",
    "content": "This document describes the usage of CAN bootloader host tools . ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/readme.html#can-bootloader-tools-help",
    "relUrl": "/tools/readme.html#can-bootloader-tools-help"
  },"2": {
    "doc": "CAN Bootloader Host Tools",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/readme.html#downloading-the-host-tools",
    "relUrl": "/tools/readme.html#downloading-the-host-tools"
  },"3": {
    "doc": "CAN Bootloader Host Tools",
    "title": "CAN Bootloader Host Tools",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/readme.html",
    "relUrl": "/tools/readme.html"
  },"4": {
    "doc": "CAN Fail Safe Bootloader",
    "title": "CAN Fail Safe Bootloader",
    "content": "This example application shows how to use the Bootloader Library to bootload an application on device having dual flash bank feature using CAN-FD protocol . Bootloader Application . | This is a fail safe bootloader application which resides from starting location of both the banks of device flash memory region for SAM devices with dual bank support | It uses CAN peripheral library in non-interrupt mode | Trigger Methods . | It uses the On board Switch as bootloader trigger pin to force enter the bootloader at reset of device | It checks for bootloader request pattern (0x5048434D) from the starting 16 Bytes of RAM to force enter bootloader at reset of device | . | . NVM Host Application . | This is a embedded CAN host application which sends the application image stored in it’s internal flash (NVM) to the inactive bank of the target board over the CAN bus . | The user application binary must be converted to a header file containing the application image in HEX format in a C style array. A btl_bin_to_c_array.py utility is provided to do this conversion . | To program the bootloader to the inactive flash bank, the user application binary may be combined with the bootloader using the btl_app_merge_bin.py utility. The combined binary file must be converted to a header file using the btl_bin_to_c_array.py utility . | Add the generated image header file of the application or bootloader and application combined to the NVM host application project. Rebuild and program the NVM host application. This results in the application image being copied in the host MCU’s flash (NVM) . | . Test Application . | This is a test application which resides from end of bootloader size in device flash memory | It will be loaded into flash memory by bootloader application | It blinks an LED and provides console output | It uses the On board Switch to trigger the bootloader from firmware . | Once the switch is pressed it loads first 16 bytes of RAM with bootloader request pattern (0x5048434D) and resets the device | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_fail_safe_bootloader/readme.html#can-fail-safe-bootloader",
    "relUrl": "/apps/can_fail_safe_bootloader/readme.html#can-fail-safe-bootloader"
  },"5": {
    "doc": "CAN Fail Safe Bootloader",
    "title": "Development Kits",
    "content": "The following table provides links to documentation on how to build and run CAN Fail Safe bootloader on different development kits . | Development Kit | . | SAM E54 Xplained Pro Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_fail_safe_bootloader/readme.html#development-kits",
    "relUrl": "/apps/can_fail_safe_bootloader/readme.html#development-kits"
  },"6": {
    "doc": "CAN Fail Safe Bootloader",
    "title": "CAN Fail Safe Bootloader",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_fail_safe_bootloader/readme.html",
    "relUrl": "/apps/can_fail_safe_bootloader/readme.html"
  },"7": {
    "doc": "CAN Bootloader",
    "title": "CAN Bootloader",
    "content": "This example application shows how to use the Bootloader Library to bootload an application using CAN-FD protocol. Bootloader Application . | This is a bootloader application which resides from starting location of the device flash memory | It uses CAN peripheral library in non-interrupt mode | Trigger Methods . | It uses the On board Switch as bootloader trigger pin to force enter the bootloader at reset of device | It checks for bootloader request pattern (0x5048434D) from the starting 16 Bytes of RAM to force enter bootloader at reset of device | . | . NVM Host Application . | This is a embedded CAN host application which sends the application image stored in it’s internal flash (NVM) to the target board over the CAN bus | The user application binary must be converted to a header file containing the application image in HEX format in a C style array. A btl_bin_to_c_array.py utility is provided to do this conversion . | Add the generated application image header file to the NVM host application project. Rebuild and program the NVM host application. This results in the application image being copied in the host MCU’s flash (NVM) | . Test Application . | This is a test application which resides from end of bootloader size in device flash memory | It will be loaded into flash memory by bootloader application | It blinks an LED and provides console output | It uses the On board Switch to trigger the bootloader from firmware (May not be supported on all devices) . | Once the switch is pressed it loads first 16 bytes of RAM with bootloader request pattern (0x5048434D) and resets the device | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/readme.html#can-bootloader",
    "relUrl": "/apps/can_bootloader/readme.html#can-bootloader"
  },"8": {
    "doc": "CAN Bootloader",
    "title": "Development Kits",
    "content": "The following table provides links to documentation on how to build and run CAN bootloader on different development kits . | Development Kit | . | SAM C21N Xplained Pro Evaluation Kit | . | SAM E54 Xplained Pro Evaluation Kit | . | SAM E70 Xplained Ultra Evaluation Kit | . | SAM V71 Xplained Ultra Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/readme.html#development-kits",
    "relUrl": "/apps/can_bootloader/readme.html#development-kits"
  },"9": {
    "doc": "CAN Bootloader",
    "title": "CAN Bootloader",
    "content": ". To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/readme.html",
    "relUrl": "/apps/can_bootloader/readme.html"
  },"10": {
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html#bootloader-and-application-binary-merge-script-help",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html#downloading-the-host-script",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html#setting-up-the-host-pc",
    "relUrl": "/tools/docs/readme_btl_app_merge_bin.html#setting-up-the-host-pc"
  },"13": {
    "doc": "Bootloader and Application binary merge script",
    "title": "Description",
    "content": ". | This script should be used to merge the bootloader binary and application binary . | It creates a merged binary output where bootloader is placed from start and the application will be placed at the offset passed as parameter . | If the application offset is not equal to end of bootloader offset it fills the gap with 0xFF until the application offset . | The merged binary can be used by CAN NVM Host Application as input for Updating bootloader and application together . | The merged binary will be created in the directory from where the script was called . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html#description",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html#usage-examples",
    "relUrl": "/tools/docs/readme_btl_app_merge_bin.html#usage-examples"
  },"15": {
    "doc": "Bootloader and Application binary merge script",
    "title": "Bootloader and Application binary merge script",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_app_merge_bin.html",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html#binary-to-c-array-script-help",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html#downloading-the-host-script",
    "relUrl": "/tools/docs/readme_btl_bin_to_c_array.html#downloading-the-host-script"
  },"18": {
    "doc": "Binary to C Array script help",
    "title": "Setting up the Host PC",
    "content": ". | The Script is compatible with Python 3.x and higher | . ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html#setting-up-the-host-pc",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html#description",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html#usage-examples",
    "relUrl": "/tools/docs/readme_btl_bin_to_c_array.html#usage-examples"
  },"21": {
    "doc": "Binary to C Array script help",
    "title": "Binary to C Array script help",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/tools/docs/readme_btl_bin_to_c_array.html",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded",
    "relUrl": "/apps/docs/readme_configure_application.html#configuring-an-application-to-be-bootloaded"
  },"23": {
    "doc": "Application Configurations",
    "title": "Application Configurations",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application.html",
    ...
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application_sam.html#configuring-an-application-to-be-bootloaded-for-cortex-m-based-mcus",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application_sam.html#application-settings-in-mcc-system-configuration",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application_sam.html#additional-settings-optional",
    ...
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_application_sam.html",
    ...
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_host_app_nvm.html#configuring-the-nvm-host-applications",
    ...
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the NVM host applications within the repository are . | apps/can_bootloader/ | apps/can_fail_safe_bootloader/ | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_host_app_nvm.html#downloading-and-building-the-application",
    ...
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_host_app_nvm.html",
    ...
    "content": ". | To configure NVM based host application refer to NVM Host Application Configuration | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_host_application.html#configuring-a-host-application-used-to-send-an-application-binary-to-bootloader",
    ...
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/docs/readme_configure_host_application.html",
    "relUrl": "/apps/docs/readme_configure_host_application.html"
  },"36": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Building and Running the CAN Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#building-and-running-the-can-bootloader-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#building-and-running-the-can-bootloader-applications"
  },"37": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the application within the repository is apps/can_bootloader/ . To build the application, refer to the following table and open the project using its IDE. Bootloader Application . | Project Name | Description | . | bootloader/firmware/sam_c21n_xpro.X | MPLABX Project for SAM C21N Xplained Pro Evaluation Kit | . Test Application . | Project Name | Description | . | test_app/firmware/sam_c21n_xpro.X | MPLABX Project for SAM C21N Xplained Pro Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#downloading-and-building-the-application"
  },"38": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Setting up SAM C21N Xplained Pro Evaluation Kit",
    "content": ". | SAM C21N Xplained Pro Evaluation Kit is used for both Host Development kit and Target Development kit . | Connect the CANL on CAN0 connector of the Host development kit to the CANL on CAN0 connector of the Target development kit | Connect the CANH on CAN0 connector of the Host development kit to the CANH on CAN0 connector of the Target development kit | Connect a ground wire between the Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#setting-up-sam-c21n-xplained-pro-evaluation-kit",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#setting-up-sam-c21n-xplained-pro-evaluation-kit"
  },"39": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Building and Configuring CAN Host Applications",
    "content": "Using CAN NVM Host application to send the application binary to Target development kit . If the NVM Host Development Kit being used is other than SAM C21N Xplained Pro Evaluation Kit then follow the steps mentioned in Configuring NVM Host application project . | Open the NVM host application project host_app_nvm/firmware/sam_c21n_xpro.X in the IDE . | If a NVM host application project of different development kit is used then open that project in the IDE | . | Build and program the NVM host application using the IDE on to the Host development kit . | The prebuilt test application image available under host_app_nvm/firmware/src/test_app_images/image_pattern_hex_sam_c21n_xpro.h will be programmed on to the Target development kit with default host_app_nvm project configuration | . | Jump to Running The Application | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#building-and-configuring-can-host-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#building-and-configuring-can-host-applications"
  },"40": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#running-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#running-the-application"
  },"41": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    "content": "Using CAN NVM Host application . | To bootload any application other than host_app_nvm/firmware/src/test_app_images/image_pattern_hex_sam_c21n_xpro.h refer to Application Configurations . | Once the application is configured, Refer to Configuring NVM Host application project for setting up the host_app_nvm project . | Once done repeat the applicable steps mentioned in Running The Application . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#additional-steps-optional",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html#additional-steps-optional"
  },"42": {
    "doc": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "title": "Building and Running on SAM C21N Xplained Pro Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_c21n_xpro.html",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_c21n_xpro.html"
  },"43": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Running the CAN Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-can-bootloader-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e54_xpro.html#building-and-running-the-can-bootloader-applications"
  },"44": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e54_xpro.html#downloading-and-building-the-application"
  },"45": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Setting up SAM E54 Xplained Pro Evaluation Kit",
    "content": ". | SAM E54 Xplained Pro Evaluation Kit is used for both Host Development kit and Target Development kit . | Connect the CANL on CAN Header of the Host development kit to the CANL on CAN Header of the Target development kit | Connect the CANH on CAN Header of the Host development kit to the CANH on CAN Header of the Target development kit | Connect a ground wire between the Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e54_xpro.html#setting-up-sam-e54-xplained-pro-evaluation-kit"
  },"46": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Building and Configuring CAN Host Applications",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e54_xpro.html#building-and-configuring-can-host-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e54_xpro.html#building-and-configuring-can-host-applications"
  },"47": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Running the Application",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e54_xpro.html#running-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e54_xpro.html#running-the-application"
  },"48": {
    "doc": "Building and Running on SAM E54 Xplained Pro Evaluation Kit",
    "title": "Additional Steps (Optional)",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html#downloading-and-building-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html#downloading-and-building-the-application"
  },"58": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Setting up SAM E70 Xplained Ultra Evaluation Kit",
    "content": ". | SAM E70 Xplained Ultra Evaluation Kit is used for both Host Development kit and Target Development kit . | Connect the CANL on CAN Header (J804) of the Host development kit to the CANL on CAN Header (J804) of the Target development kit | Connect the CANH on CAN Header (J804) of the Host development kit to the CANH on CAN Header (J804) of the Target development kit | Connect a ground wire between the Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html#setting-up-sam-e70-xplained-ultra-evaluation-kit",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html#setting-up-sam-e70-xplained-ultra-evaluation-kit"
  },"59": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Building and Configuring CAN Host Applications",
    "content": "Using CAN NVM Host application to send the application binary to Target development kit . If the NVM Host Development Kit being used is other than SAM E70 Xplained Ultra Evaluation Kit then follow the steps mentioned in Configuring NVM Host application project . | Open the NVM host application project host_app_nvm/firmware/sam_e70_xult.X in the IDE . | If a NVM host application project of different development kit is used then open that project in the IDE | . | Build and program the NVM host application using the IDE on to the Host development kit . | The prebuilt test application image available under host_app_nvm/firmware/src/test_app_images/image_pattern_hex_sam_e70_xult.h will be programmed on to the Target development kit with default host_app_nvm project configuration | . | Jump to Running The Application | . MCAN Message RAM configuration . | Allocate MCAN Message RAM configuration in contiguous non-cacheable buffer in the NVM host application. For example, static uint8_t CACHE_ALIGN attribute((space(data), section (“.ram_nocache”))) mcan1MessageRAM[MCAN1_MESSAGE_RAM_CONFIG_SIZE]; . | Add non-cacheable section “ram_nocache” in the Custom linker script apps/can_bootloader/host_app_nvm/firmware/src/config/sam_e70_xult/ATSAME70Q21B.ld . | Please refer How to Create Non-Cacheable Memory Region on CortexM7 (SAM S70/ E70/ V70/ V71) MCUs Using MPLAB Harmony v3 to create a non-cacheable memory region. | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html#building-and-configuring-can-host-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html#building-and-configuring-can-host-applications"
  },"60": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Running the Application",
    "content": ". | Open the bootloader project bootloader/firmware/sam_e70_xult.X in the IDE | Build and program the application using the IDE on to the Target development kit . | LED1 will be turned-on to indicate that bootloader code is running on the target | LED1 will also turn on when the bootloader does not find a valid application; i.e. the first word of the application (stack pointer), contains 0xFFFFFFFF | . | If the test application is being programmed, Open the Terminal application (Ex.:Tera Term) on the computer and configure the serial port settings for Target Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Press the Switch SW0 on the Host development kit to trigger programming of the application binary | Once the programming is complete, . | LED1 on the Host development kit will be turned on indicating success . | The target development kit will be reset. Upon re-start, the boot-loader will jump to the user application . | If the test application is programmed then LED1 should start blinking and you should see below output on the Target development kit console . | . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Press Reset button on the Host development kit to reprogram the application binary | Repeat Steps 4-5 once . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 6 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html#running-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html#running-the-application"
  },"61": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Additional Steps (Optional)",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html#additional-steps-optional",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html#additional-steps-optional"
  },"62": {
    "doc": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "title": "Building and Running on SAM E70 Xplained Ultra Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_e70_xult.html",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_e70_xult.html"
  },"63": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Building and Running the CAN Bootloader applications",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#building-and-running-the-can-bootloader-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#building-and-running-the-can-bootloader-applications"
  },"64": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Downloading and building the application",
    "content": "To clone or download this application from Github,go to the main page of this repository and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following these instructions . Path of the application within the repository is apps/can_bootloader/ . To build the application, refer to the following table and open the project using its IDE. Bootloader Application . | Project Name | Description | . | bootloader/firmware/sam_v71_xult.X | MPLABX Project for SAM V71 Xplained Ultra Evaluation Kit | . Test Application . | Project Name | Description | . | test_app/firmware/sam_v71_xult.X | MPLABX Project for SAM V71 Xplained Ultra Evaluation Kit | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#downloading-and-building-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#downloading-and-building-the-application"
  },"65": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Setting up SAM V71 Xplained Ultra Evaluation Kit",
    "content": ". | SAM V71 Xplained Ultra Evaluation Kit is used for both Host Development kit and Target Development kit . | Connect the CAN_L on CAN connector of the Host development kit to the CAN_L on CAN connector of the Target development kit | Connect the CAN_H on CAN connector of the Host development kit to the CAN_H on CAN connector of the Target development kit | Connect a ground wire between the Host development kit and Target development kit | Connect the Debug USB port on the Host development kit to the computer using a micro USB cable | Connect the Debug USB port on the Target development kit to the computer using a micro USB cable | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#setting-up-sam-v71-xplained-ultra-evaluation-kit",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#setting-up-sam-v71-xplained-ultra-evaluation-kit"
  },"66": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Building and Configuring CAN Host Applications",
    "content": "Using CAN NVM Host application to send the application binary to Target development kit . If the NVM Host Development Kit being used is other than SAM V71 Xplained Ultra Evaluation Kit then follow the steps mentioned in Configuring NVM Host application project . | Open the NVM host application project host_app_nvm/firmware/sam_v71_xult.X in the IDE . | If a NVM host application project of different development kit is used then open that project in the IDE | . | Build and program the NVM host application using the IDE on to the Host development kit . | The prebuilt test application image available under host_app_nvm/firmware/src/test_app_images/image_pattern_hex_sam_v71_xult.h will be programmed on to the Target development kit with default host_app_nvm project configuration | . | Jump to Running The Application | . MCAN Message RAM configuration . | Allocate MCAN Message RAM configuration in contiguous non-cacheable buffer in the NVM host application. For example, static uint8_t CACHE_ALIGN attribute((space(data), section (“.ram_nocache”))) mcan1MessageRAM[MCAN1_MESSAGE_RAM_CONFIG_SIZE]; . | Add non-cacheable section “ram_nocache” in the Custom linker script apps/can_bootloader/host_app_nvm/firmware/src/config/sam_v71_xult/ATSAMV71Q21B.ld . | Please refer How to Create Non-Cacheable Memory Region on CortexM7 (SAM S70/ E70/ V70/ V71) MCUs Using MPLAB Harmony v3 to create a non-cacheable memory region. | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#building-and-configuring-can-host-applications",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#building-and-configuring-can-host-applications"
  },"67": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Running the Application",
    "content": ". | Open the bootloader project bootloader/firmware/sam_v71_xult.X in the IDE | Build and program the application using the IDE on to the Target development kit . | LED0 will be turned-on to indicate that bootloader code is running on the target | LED0 will also turn on when the bootloader does not find a valid application; i.e. the first word of the application (stack pointer), contains 0xFFFFFFFF | . | If the test application is being programmed, Open the Terminal application (Ex.:Tera Term) on the computer and configure the serial port settings for Target Development kit as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | Press the Switch SW0 on the Host development kit to trigger programming of the application binary | Once the programming is complete, . | LED0 on the Host development kit will be turned on indicating success . | The target development kit will be reset. Upon re-start, the boot-loader will jump to the user application . | If the test application is programmed then LED1 should start blinking and you should see below output on the Target development kit console . | . | Press and hold the Switch SW0 to trigger Bootloader from test application and you should see below output . | Press Reset button on the Host development kit to reprogram the application binary | Repeat Steps 4-5 once . | This step is to verify that bootloader is running after triggering bootloader from test application in Step 6 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#running-the-application",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#running-the-application"
  },"68": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Additional Steps (Optional)",
    ...
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html#additional-steps-optional",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html#additional-steps-optional"
  },"69": {
    "doc": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "title": "Building and Running on SAM V71 Xplained Ultra Evaluation Kit",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/apps/can_bootloader/docs/readme_sam_v71_xult.html",
    "relUrl": "/apps/can_bootloader/docs/readme_sam_v71_xult.html"
  },"70": {
    "doc": "Release notes",
    "title": "Microchip MPLAB® Harmony 3 Release Notes",
    "content": " ",
    "url": "http://localhost:4000/bootloader_apps_can/release_notes.html#microchip-mplab-harmony-3-release-notes",
    "relUrl": "/release_notes.html#microchip-mplab-harmony-3-release-notes"
  },"71": {
    "doc": "Release notes",
    "title": "CAN Bootloader Applications Release v3.1.0",
    "content": "Development kit and demo application support . | The following table provides bootloader demo applications available for different development kits. | Product Family | Development Kits | CAN | CAN Fail Safe | . | SAM C20/C21 | SAM C21N Xplained Pro Evaluation Kit | Yes | NA | . | SAM D5x/E5x | SAM E54 Xplained Pro Evaluation Kit | Yes | Yes | . | SAM E70/S70/V70/V71 | SAM E70 Xplained Ultra Evaluation Kit | Yes | NA | . | SAM E70/S70/V70/V71 | SAM V71 Xplained Ultra Evaluation Kit | Yes | NA | . | NA: Lack of product capability . | . Known Issues . | No changes from v3.0.0 | . Development Tools . | MPLAB® X IDE v6.05 | MPLAB® XC32 C/C++ Compiler v4.20 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator (MCC) v5.1.17 | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/release_notes.html#can-bootloader-applications-release-v310",
    "relUrl": "/release_notes.html#can-bootloader-applications-release-v310"
  },"72": {
    "doc": "Release notes",
    "title": "CAN Bootloader Applications Release v3.0.0",
    "content": "New Features . | This release includes support of . | CAN Bootloader Applications for SAM family of 32-bit microcontrollers. | CAN Fail Safe Bootloader for devices with dual flash bank support. | . | . Development kit and demo application support . | The following table provides bootloader demo applications available for different development kits. | Product Family | Development Kits | CAN | CAN Fail Safe | . | SAM C20/C21 | SAM C21N Xplained Pro Evaluation Kit | Yes | NA | . | SAM D5x/E5x | SAM E54 Xplained Pro Evaluation Kit | Yes | Yes | . | SAM E70/S70/V70/V71 | SAM E70 Xplained Ultra Evaluation Kit | Yes | NA | . | SAM E70/S70/V70/V71 | SAM V71 Xplained Ultra Evaluation Kit | Yes | NA | . | NA: Lack of product capability . | . Known Issues . The current known issues are as follows: . | Initialized global variables will not be initialized at startup for CAN bootloaders. | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® XC32 C/C++ Compiler v3.00 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony 3 Launcher v3.6.4 and above. | . | . ",
    "url": "http://localhost:4000/bootloader_apps_can/release_notes.html#can-bootloader-applications-release-v300",
    "relUrl": "/release_notes.html#can-bootloader-applications-release-v300"
  },"73": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": ". ",
    "url": "http://localhost:4000/bootloader_apps_can/release_notes.html",
    "relUrl": "/release_notes.html"
  },"74": {
    "doc": "CAN Bootloader Applications",
    "title": "CAN Bootloader Applications",
    "content": "![Microchip logo](https://raw.githubusercontent.com/wiki/Microchip-MPLAB-Harmony/Microchip-MPLAB-Harmony.github.io/images/microchip_logo.png) # MPLAB® Harmony 3 CAN Bootloader Application Examples MPLAB® Harmony 3 is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB Harmony Pages](https://microchip-mplab-harmony.github.io/) This repository contains the MPLAB® Harmony 3 CAN Bootloader application examples - [Release Notes](/bootloader_apps_can/release_notes.html) - [MPLAB® Harmony License](/bootloader_apps_can/mplab_harmony_license.html) To clone or download these application from Github,go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_can) and then click Clone button to clone this repo or download as zip file. This content can also be download using content manager by following [these instructions](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki) ## Contents Summary | Folder | Description | --- | --- | apps | CAN Bootloader example applications | docs | Applications help documentation | ## Bootloader Examples The following applications are provided to demonstrate the CAN Bootloader | Name | Description | --------- | ----------- | [CAN Bootloader](/bootloader_apps_can/apps/can_bootloader/readme.html) | This example application shows how to use the Bootloader Library to bootload an application using CAN-FD protocol | [CAN Faile Safe Bootloader](/bootloader_apps_can/apps/can_fail_safe_bootloader/readme.html) | This example application shows how to use the Bootloader Library to bootload an application on device having dual flash bank feature using CAN-FD protocol | ## Bootloader Library Refer to [Bootloader Library Help](https://microchip-mplab-harmony.github.io/bootloader) for understanding - Bootloader framework - How the Bootloader library works - Bootloader library configurations - Bootloader memory layout ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_can/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/Microchip-MPLAB-Harmony/bootloader_apps_can.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_can/releases/latest) [![Latest release date](https://img.shields.io/github/release-date/Microchip-MPLAB-Harmony/bootloader_apps_can.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_can/releases/latest) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/bootloader_apps_can.svg)](https://github.com/Microchip-MPLAB-Harmony/bootloader_apps_can/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/bootloader_apps_can.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/bootloader_apps_can.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/bootloader_apps_can.svg?style=social)]() ",
    "url": "http://localhost:4000/bootloader_apps_can/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "bootloader_apps_can";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "CAN Bootloader Applications";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/bootloader_apps_can/assets/css/just-the-docs-' + theme + '.css');
}
